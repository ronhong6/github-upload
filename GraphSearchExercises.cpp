...
int GridGraph::countEdges() const {
  ...
  // TODO: Your code here!
  // =======================================================================
  for (std::unordered_map<IntPair, GridGraph::NeighborSet>::const_iterator it = adjacencyMap.begin(); it != adjacencyMap.end(); it++) {
...
void GridGraph::removePoint(const IntPair& p1) {
  ...
  for (GridGraph::NeighborSet::const_iterator it = originalNeighbors.begin(); it != originalNeighbors.end(); it++) {
